...
const AccountWizardStepResults = ({ accountName, edit, error, errorMessage, fulfilled, pending }) => (
  <React.Fragment>
    {error && (
...
AccountWizardStepResults.propTypes = {
...
AccountWizardStepResults.defaultProps = {
  accountName: null,
  edit: false,
  error: false,
  errorMessage: null,
...
const ConnectedAccountWizardStepResults = connect(mapStateToProps)(AccountWizardStepResults);

export { ConnectedAccountWizardStepResults as default, ConnectedAccountWizardStepResults, AccountWizardStepResults };
